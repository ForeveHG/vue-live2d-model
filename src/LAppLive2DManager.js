...
function LAppLive2DManager(live) {
    ...
    Live2D.init();
    Live2DFramework.setPlatformManager(new PlatformManager(this.live));
...
LAppLive2DManager.prototype.changeModel = function (gl, order) {
