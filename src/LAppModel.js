                    ...
                    if (thisRef.isTexLoaded) {
                        ...
                        if (thisRef.modelSetting.getExpressionNum() > 0) {
                            ...
                            for (var j = 0; j < thisRef.modelSetting.getExpressionNum(); j++) {
                                ...
                                thisRef.loadExpression(expName, modelSettingPath);
                            }
                        } else {
                        ...
                        if (thisRef.modelSetting.getPhysicsFile() != null) {
                            var file = thisRef.modelSetting.getPhysicsFile()
                            var path = file;
                            if(typeof file !== 'object') path = thisRef.modelHomeDir + path
                            thisRef.loadPhysics(path);
                        } else {
                        ...
                        if (thisRef.modelSetting.getPoseFile() != null) {
                            var file = thisRef.modelSetting.getPoseFile()
                            var path = file;
                            if(typeof file !== 'object') path = thisRef.modelHomeDir + path
                            thisRef.loadPose(
                                path,
